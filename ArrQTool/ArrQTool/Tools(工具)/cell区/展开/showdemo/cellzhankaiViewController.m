...
#import "cellzhankaiViewController.h"
...
@interface cellzhankaiViewController ()<UITableViewDelegate,UITableViewDataSource, CellBtnDelegate>

@property(nonatomic, strong)UITableView      *tabelView;
@property(nonatomic, strong)NSMutableArray   *dataArr;
@end

@implementation cellzhankaiViewController

...
#import "PKBottomZuoHaoView.h"

#import "PKZuoHaoTableViewCell.h"

@interface PKBottomZuoHaoView ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation PKBottomZuoHaoView
...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        [_tableView registerClass:[PKZuoHaoTableViewCell class] forCellReuseIdentifier:@"PKZuoHaoTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PKZuoHaoTableViewCell *homeCell_000 = [tableView dequeueReusableCellWithIdentifier:@"PKZuoHaoTableViewCell"];

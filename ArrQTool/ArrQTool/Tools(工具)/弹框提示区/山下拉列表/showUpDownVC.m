...
#import "showUpDownVC.h"

#import "dopDownVC.h"


@interface showUpDownVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)btnOnClick:(UIButton *)sender{
    ...
    CGPoint startPoint =
    CGPointMake(CGRectGetMidX(rect), CGRectGetMaxY(rect) - sender.frame.size.height);
...
//        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 100, 200) style:UITableViewStylePlain];
        ...
        _tableView.frame = CGRectMake(0, 0, 50, 44*self.moShiDataArray.count);

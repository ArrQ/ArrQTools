...
#define kAppGrayColor102     [UIColor darkGrayColor]  // 副标题1       RGBColor(102, 102, 102, 1.0)
#define kTopViewHeight 44
#define kAppBottomBtnColor       RGB_Color(248, 153, 60 , 1.0)   // 底部 按钮  颜色  TVRGBColor(248, 153, 60)
...
- (void)createView
{
    ...
    _topView.backgroundColor = kAppBottomBtnColor;
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    if (!pickerLabel)
    {
        ...
        pickerLabel.textColor = kAppGrayColor102;

...
@interface yyshowxingxingOneView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation yyshowxingxingOneView
...
- (UICollectionView *)collectionView{
    ...
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[yyxingxingCollectionViewCell class] forCellWithReuseIdentifier:@"yyxingxingCollectionViewCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    yyxingxingCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"yyxingxingCollectionViewCell" forIndexPath:indexPath];

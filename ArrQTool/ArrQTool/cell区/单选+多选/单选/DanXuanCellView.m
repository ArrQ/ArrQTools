...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[DanxuanCollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [DanxuanCollectionViewCell cellWithCollectionView:collectionView andModel:self.dataArray[indexPath.row] index:indexPath];
